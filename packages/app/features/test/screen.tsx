...
import { ContentLesson11 } from '../lesson11/type_Lesson11';
import { ContentLesson11_2 } from '../lesson11/type_Lesson11';
import { ContentLesson11_3 } from '../lesson11/type_Lesson11';
...
const EleventhLesson = data.lessons.find(lesson => lesson.name.toLowerCase().includes(lessonName.toLowerCase()));

const partName1 =  "l11p2";
const EleventPartTwohLesson = data.lessons.find(lesson => lesson.name === partName1);

const partName2 =  "l11p3";
const EleventPartThrihLesson = data.lessons.find(lesson => lesson.name === partName2);
    ...
    <YStack>
        ...
        <YStack f={1}>
          <YStack ai="center" mt="$10">
            ...
            <YStack  w="100%" $gtSm={{ width: "70%" }}>
              <VideoPlayer linkVideo={content3?.video}/>
            </YStack>
