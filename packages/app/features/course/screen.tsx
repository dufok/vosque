      ...
      <YStack maw={900}>
        <XStack mt="$4" jc="space-between" fw='wrap'>
          <YStack w='50%' $sm={{ width: '100%' }}>
            <YStack w='100%' p='$5'>
              <H4 >Фонетика</H4>
              <Paragraph ta="left" >В первом уроке мы изучим фонетику испанского языка в Аргентине. Это не самый интересный, но очень важный материал, который позволит Вам дальше читать слова и выражения правильно, а так же интонировать так, как это делают носители!</Paragraph>
            </YStack>
          </YStack>
          <YStack w='50%' $sm={{ width: '100%' }}>
            <XStack h='100%'>
